...
struct MMCOContext {
    ...
    int (*world_rename)(void* mh, const char* instance_id, int index,
                        const char* new_name);
    int (*world_install)(void* mh, const char* instance_id, const char* filepath);
    ...
    void (*ui_show_message)(void* mh, int type,
    ...
    /* Button */
    void* (*ui_button_create)(void* mh, void* parent,
                              const char* text, const char* icon_name,
    ...
    void* (*ui_tree_create)(void* mh, void* parent,
                            const char** column_names, int column_count,
                            MMCOTreeSelectionCallback on_select, void* user_data);
    int (*ui_tree_clear)(void* mh, void* tree);
    int (*ui_tree_add_row)(void* mh, void* tree,
                           const char** values, int col_count);
