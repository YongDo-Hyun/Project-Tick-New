...
class PluginManager : public QObject {
  ...
  public:
     ...
     */
    const QVector<PluginMetadata>& modules() const { return m_modules; }
  ...
  private:
    ...
    static int api_instance_set_name(void* mh, const char* id, const char* name);
    ...
    static int api_instance_set_icon_key(void* mh, const char* id, const char* key);
    ...
    static int api_instance_set_notes(void* mh, const char* id, const char* notes);
    ...
    static int api_instance_set_group(void* mh, const char* id, const char* group);
    ...
    static const char* api_instance_component_get_uid(void* mh, const char* id, int idx);
    static const char* api_instance_component_get_name(void* mh, const char* id, int idx);
    static const char* api_instance_component_get_version(void* mh, const char* id, int idx);
    ...
    static const char* api_instance_get_resource_packs_dir(void* mh, const char* id);
    static const char* api_instance_get_texture_packs_dir(void* mh, const char* id);
    static const char* api_instance_get_shader_packs_dir(void* mh, const char* id);
    ...
    static const char* api_mod_get_name(void* mh, const char* inst, const char* type, int idx);
    static const char* api_mod_get_version(void* mh, const char* inst, const char* type, int idx);
    static const char* api_mod_get_filename(void* mh, const char* inst, const char* type, int idx);
    static const char* api_mod_get_description(void* mh, const char* inst, const char* type, int idx);
    static int api_mod_is_enabled(void* mh, const char* inst, const char* type, int idx);
    static int api_mod_set_enabled(void* mh, const char* inst, const char* type, int idx, int e);
    static int api_mod_remove(void* mh, const char* inst, const char* type, int idx);
    static int api_mod_install(void* mh, const char* inst, const char* type, const char* path);
    ...
    static const char* api_world_get_folder(void* mh, const char* inst, int idx);
    ...
    static int64_t api_world_get_last_played(void* mh, const char* inst, int idx);
    static int api_world_delete(void* mh, const char* inst, int idx);
    static int api_world_rename(void* mh, const char* inst, int idx, const char* name);
    ...
    static int api_fs_write(void* mh, const char* rel, const void* data, size_t sz);
    ...
    /* Section 11: Network */
    static int api_http_get(void* mh, const char* url,
                            MMCOHttpCallback cb, void* ud);
    static int api_http_post(void* mh, const char* url,
                             const void* body, size_t body_sz,
                             const char* ct,
                             MMCOHttpCallback cb, void* ud);

    /* Section 12: UI Dialogs */
    static void api_ui_show_message(void* mh, int type,
    ...
    static const char* api_ui_file_save_dialog(void* mh, const char* title,
                                               const char* def, const char* filter);
    static const char* api_ui_input_dialog(void* mh, const char* title,
                                           const char* prompt, const char* def);
    static int api_ui_confirm_dialog(void* mh, const char* title, const char* msg);
    ...
    static void* api_ui_page_create(void* mh, const char* id,
    ...
    static void* api_ui_button_create(void* mh, void* parent, const char* text,
                                      const char* icon, MMCOButtonCallback cb, void* ud);
    ...
    static void* api_ui_tree_create(void* mh, void* parent,
                                    const char** cols, int ncols,
                                    MMCOTreeSelectionCallback cb, void* ud);
    static int api_ui_tree_clear(void* mh, void* tree);
    static int api_ui_tree_add_row(void* mh, void* tree, const char** vals, int ncols);
    static int api_ui_tree_selected_row(void* mh, void* tree);
    static int api_ui_tree_set_row_data(void* mh, void* tree, int row, int64_t data);
  ...
  public:
    ...
    const QVector<InstanceAction>& instanceActions() const { return m_instanceActions; }
