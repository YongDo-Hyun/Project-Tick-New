...
#
# english.nsi: English language strings for gmnv NSIS installer.
#
# Locale ID    : 1033
# Locale Name  : en
# fileencoding : UTF-8
...
LangString mnv_readme_file ${LANG_ENGLISH} "README.txt"
...
LangString str_desc_old_ver         ${LANG_ENGLISH} \
    "Uninstall existing MNV version(s) from your system."
...
LangString str_section_mnv_rc       ${LANG_ENGLISH} \
    "Create Default Config"
LangString str_desc_mnv_rc          ${LANG_ENGLISH} \
    "Create a default config file (_mnvrc) if one does not already exist."

LangString str_group_plugin         ${LANG_ENGLISH} \
    "Create Plugin Directories"
LangString str_desc_plugin          ${LANG_ENGLISH} \
    "Create plugin directories.  Plugin directories allow extending MNV \
...
LangString str_section_plugin_mnv   ${LANG_ENGLISH} \
    "Shared"
LangString str_desc_plugin_mnv      ${LANG_ENGLISH} \
    "Create plugin directories in MNV install directory, it is used for \
...
LangString str_unsection_plugin_mnv ${LANG_ENGLISH} \
    "Shared"
LangString str_desc_rm_plugin_mnv   ${LANG_ENGLISH} \
...
#LangString str_msg_mnv_running   ${LANG_ENGLISH} \
...
LangString str_mnvrc_page_title    ${LANG_ENGLISH} \
    "Choose _mnvrc settings"
LangString str_mnvrc_page_subtitle ${LANG_ENGLISH} \
...
LangString str_msg_compat_vi       ${LANG_ENGLISH} \
    "Vi compatible"
LangString str_msg_compat_mnv      ${LANG_ENGLISH} \
    "MNV original"
