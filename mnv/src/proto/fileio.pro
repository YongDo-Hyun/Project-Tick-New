...
int mnv_fgets(char_u *buf, int size, FILE *fp);
int mnv_rename(char_u *from, char_u *to);
int mnv_copyfile(char_u *from, char_u *to);
...
void mnv_deltempdir(void);
char_u *mnv_tempname(int extra_char, int keep);
