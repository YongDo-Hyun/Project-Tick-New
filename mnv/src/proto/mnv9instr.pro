...
int generate_MNV9SCRIPT(cctx_T *cctx, isntype_T isn_type, int sid, int idx, type_T *type);
...
int generate_store_var(cctx_T *cctx, assign_dest_T dest, int opt_flags, int mnvvaridx, type_T *type, char_u *name, lhs_T *lhs);
