/* mnv9script.c */
int in_mnv9script(void);
int in_old_script(int max_version);
int current_script_is_mnv9(void);
void clear_mnv9_scriptlocal_vars(int sid);
void ex_mnv9script(exarg_T *eap);
int not_in_mnv9(exarg_T *eap);
int mnv9_bad_comment(char_u *p);
int mnv9_comment_start(char_u *p);
...
char_u *mnv9_declare_scriptvar(exarg_T *eap, char_u *arg);
void update_mnv9_script_var(int create, dictitem_T *di, char_u *name, int flags, typval_T *tv, type_T **type, int do_member);
