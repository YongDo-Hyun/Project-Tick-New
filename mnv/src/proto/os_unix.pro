...
int mnv_is_xterm(char_u *name);
int use_xterm_like_mouse(char_u *name);
int use_xterm_mouse(void);
int mnv_is_iris(char_u *name);
int mnv_is_vt300(char_u *name);
...
void mch_set_acl(char_u *fname, mnv_acl_T aclent);
void mch_free_acl(mnv_acl_T aclent);
