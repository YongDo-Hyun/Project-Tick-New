...
void mnv9_declare_error(char_u *name);
int get_var_dest(char_u *name, assign_dest_T *dest, cmdidx_T cmdidx, int *option_scope, int *mnvvaridx, type_T **type, cctx_T *cctx);
