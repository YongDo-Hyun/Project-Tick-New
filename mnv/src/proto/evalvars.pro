...
int garbage_collect_mnvvars(int copyID);
...
void prepare_mnvvar(int idx, typval_T *save_tv);
void restore_mnvvar(int idx, typval_T *save_tv);
int is_scoped_variable(char_u *name);
char_u *eval_one_expr_in_str(char_u *p, garray_T *gap, int evaluate);
list_T *heredoc_get(exarg_T *eap, char_u *cmd, int script_get, int mnv9compile);
...
dict_T *get_mnvvar_dict(void);
int find_mnv_var(char_u *name, int *di_flags);
void set_mnv_var_type(int idx, vartype_T type);
void set_mnv_var_nr(int idx, varnumber_T val);
char *get_mnv_var_name(int idx);
typval_T *get_mnv_var_tv(int idx);
type_T *get_mnv_var_type(int idx, garray_T *type_list);
int set_mnv_var_tv(int idx, typval_T *tv);
varnumber_T get_mnv_var_nr(int idx);
char_u *get_mnv_var_str(int idx);
list_T *get_mnv_var_list(int idx);
dict_T *get_mnv_var_dict(int idx);
void set_mnv_var_char(int c);
void set_vcount(long count, long count1, int set_prevcount);
void save_mnvvars(mnvvars_save_T *vvsave);
void restore_mnvvars(mnvvars_save_T *vvsave);
void set_mnv_var_string(int idx, char_u *val, int len);
void set_mnv_var_string_direct(int idx, char_u *val);
void set_mnv_var_list(int idx, list_T *val);
void set_mnv_var_dict(int idx, dict_T *val);
