...
void mnv_beep(unsigned val);
void init_homedir(void);
void free_homedir(void);
void free_users(void);
void init_mnvdir(void);
...
char_u *mnv_getenv(char_u *name, int *mustfree);
void mnv_unsetenv(char_u *var);
void mnv_unsetenv_ext(char_u *var);
void mnv_setenv_ext(char_u *name, char_u *val);
void mnv_setenv(char_u *name, char_u *val);
...
int mnv_append_digit_long(long *value, int digit);
int trim_to_int(mnvlong_T x);
/* mnv: set ft=c : */
