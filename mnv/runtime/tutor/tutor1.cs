===============================================================================
=    V í t e j t e   v   t u t o r i a l u   M N V       -    Verze 1.5       =
===============================================================================

     MNV je velmi výkonný editor, který má příliš mnoho příkazů na to, aby
     mohly být všechny vysvětlené ve výuce jako tato. Tato výuka obsahuje
     dostatečné množství příkazů na to, aby bylo možné používat MNV jako
     víceúčelový editor.
     ...
     procvičování (při startu "mnvtutor" je již toto kopie).
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		     Lekce 1.1.2: SPUŠTĚNÍ A UKONČENÍ MNV
...
---> Tímto ukončíš editor BEZ uložení změn, které si vykonal.
  ...
  3. Až se dostaneš na příkazový řádek, napiš příkaz, kterým se dostaneš zpět
     do této výuky. To může být: mnvtutor <ENTER>
     Běžně se používá:		 mnv tutor <ENTER>

---> 'mnv' znamená spuštění editoru, 'tutor' je soubor k editaci.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  2. Pro spuštění MNVu (z příkazového řádku) napiš: mnv SOUBOR <ENTER>

  3. Pro ukončení MNVu napiš: <ESC>  :q!  <ENTER>  bez uložení změn.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  Vzhledem k častosti mazání celého řádku se autoři MNVu rozhodli, že bude
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  4. To uloží celý soubor  (Výuka MNVu)  pod názvem TEST.
     Pro ověření napiš znovu :!dir  , čímž zobrazíš obsah adresáře.

Poznámka: Jakmile ukončíš MNV a znovu ho spustíš s názvem souboru TEST,
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  MNV má obsáhlý on-line systém nápovědy. Pro začátek vyzkoušej jeden z
  následujících:
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		  LEKCE 1.8: VYTVOŘENÍ INICIALIZAČNÍHO SKRIPTU
		        ...
		        ** Zapni funkce editoru MNV **

  MNV má daleko více funkcí než Vi, ale většina z nich je vypnuta ve výchozím
  nastavení. Pro zapnutí některých vytvoř soubor "mnvrc".

  1. Začni upravovat soubor "mnvrc". Toto závisí na použitém systému:
	:edit ~/.mnvrc		pro Unix
	:edit ~/_mnvrc		pro MS-Windows

  2. Nyní čti ukázkový "mnvrc" soubor:
  ...
  Po příštím startu MNV se zapne zvýrazňování syntaxe.
  Do souboru "mnvrc" můžeš přidat všechny svoje upřednostňované nastavení.

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

  Toto ukončuje výuku MNV, která byla myšlená jako stručný přehled
  editoru MNV, tak akorát postačující pro lehké a obstojné používání editoru.
  Tato výuka má daleko od úplnosti, protože MNV obsahuje podstatně více
  příkazů. Dále si přečti uživatelský manuál: ":help user-manual".

  Pro další studium je doporučená kniha:
	MNV - MNV is not Vim - od Steve Oualline
  ...
  Upravil pro MNV: Bram Moolenaar.
