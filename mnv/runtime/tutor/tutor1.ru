===============================================================================
версия 1.7      =  ДОБРО  ПОЖАЛОВАТЬ  НА  ЗАНЯТИЯ  ПО  РЕДАКТОРУ  MNV  =
===============================================================================
=				ГЛАВА  ПЕРВАЯ				      =
===============================================================================

   Программа MNV -- это очень мощный текстовый редактор, имеющий множество
   ...
   лёгкостью использовать программу MNV в качестве редактора общего назначения.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 ВНИМАНИЕ! Перед выполнением описанных ниже действий, прочтите урок полностью!
  ...
  3. В приглашении командной оболочки наберите команду, которой вы открывали
	этот учебник. Это может быть  mnvtutor <ENTER>
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 ВНИМАНИЕ! Перед выполнением описанных ниже действий, прочтите урок полностью!
  ...
  1. Завершите работу редактора MNV, как указано в уроке 1.1.2  -  :q!
     Если есть доступ к другому терминалу, то там можете сделать следующее:

  2. В приглашении командной оболочки введите команду  mnv tutor <ENTER>
	где mnv - команда для запуска редактора MNV, а tutor - наименование
  ...
  4. Сохраните этот изменённый файл и завершите работу программы MNV,
	набрав команду  :wq <ENTER>

  5. Если вы вышли из mnvtutor на шаге 1, перезапустите mnvtutor и переходите
	далее к резюме.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  2. Чтобы запустить редактор MNV из приглашения командной оболочки, наберите
	mnv ФАЙЛ <ENTER>

  3. Чтобы завершить работу редактора MNV, выполните одно из следующих:
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  2. Наберите  dd  , чтобы удалить строку, при этом она будет автоматически
	помещена в специальный регистр редактора MNV.
...
Примечание.
    Если завершить работу редактора MNV и затем запустить его снова с файлом
	TEST (т. е. набрать команду  mnv TEST ), этот файл будет точной копией
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  В редакторе MNV имеется мощная встроенная справочная система, и чтобы начать
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		 Урок 1.7.2. СОЗДАНИЕ СТАРТОВОГО КОМАНДНОГО ФАЙЛА
		       ...
		       ** Включим все возможности MNV **

  Редактор MNV более функционален по сравнению с редактором Vi, но большинство
    из этих возможностей отключены при запуске программы. Чтобы активировать
    весь потенциала редактора, необходимо создать файл "mnvrc".

  1. Создайте новый файл "mnvrc". Его расположение зависит от используемой
	системы:
	    :e ~/.mnvrc			для UNIX
	    :e $MNV/_mnvrc		для MS Windows

  2. Теперь добавьте в этот файл содержимое шаблонного файла "mnvrc"
	    :r $MNVRUNTIME/mnvrc_example.mnv

  3. Запишите созданный вами файл "mnvrc"
	    :w

  Теперь при следующем запуске редактора MNV будет включена подсветка
    синтаксиса. Все необходимые вам настройки могут быть добавлены в файл
    "mnvrc".
  Чтобы получить подробную информацию, наберите  :help mnvrc-intro
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
** Подстановка в командной строке выполняется нажатием клавиш CTRL-D и <TAB> **
  ...
  4. Нажмите клавиши  CTRL-D  , и будет показан перечень команд редактора MNV
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  5. Чтобы при запуске всегда применялись необходимые вам настройки, создайте
	стартовый командный файл mnvrc.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  На этом можно завершить первую часть занятий посвящённых редактору MNV.
  ...
  Целью данного курса было дать краткий обзор редактора MNV, достаточный для
  того, чтобы не возникало сложностей при его использовании. Это далеко не
  полный обзор, поскольку в редакторе MNV есть ещё много-много команд.
  ...
  Для дальнейшего чтения рекомендуется книга
	"MNV - MNV is not Vim", автор Steve Oualline, издательство New Riders.
  Она полностью посвящена редактору MNV и будет особенно полезна новичкам.
  ...
  чем редактору MNV, однако также рекомендуется к прочтению
  ...
  Шестое издание этой книги включает информацию о редакторе MNV.
  ...
  University. E-mail: bware@mines.colorado.edu (теперь недоступен).
   ...
   Для использования в редакторе MNV уроки были доработаны Bram Moolenaar
