...
===============================================================================
  ...
  Если это ваше первое знакомство с редактором MNV и вы планировали начать
...
---> Потренируйтесь здесь на словах: «MNV'овский», (text_object) и 'мощный'.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		 ...
		 Урок 2.1.2. ИМЕНОВАННЫЕ РЕГИСТРЫ В РЕДАКТОРЕ MNV
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	       ...
	       Урок 2.1.4. НУМЕРОВАННЫЕ РЕГИСТРЫ В РЕДАКТОРЕ MNV
...
** Применение регистров буфера обмена и «чёрная дыра» для расширенной правки **
 ...
 Примечание.
    ...
    библиотеки X11 или Wayland, и сам редактор MNV должен быть скомпилирован
    с включённым компонентом «+clipboard» (обычно это максимальная версия).
    Это можно проверить с помощью следующих команд редактора MNV:
    :version
    и
...
---> "_diw на любом слове, чтобы удалить его, не затрагивая историю копирования
  ...
  4. Запомните:
   - Регистры буфера обмена доступны между разными экземплярами редактора MNV
   ...
   - Именованные регистры (a-z) остаются частными для каждой сессии MNV
  ...
  5. Устранение неполадок с буфером обмена:
     ...
     - В системе Linux может потребоваться пакет mnv-gtk или mnv-x11
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  На этом пока заканчивается вторая глава учебника по редактору MNV.
