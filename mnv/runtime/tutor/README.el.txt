...
επεξεργασίας κειμένου χρησιμοποιώντας τον συντάκτη MNV.

Το Tutor είναι ένα αρχείο που περιέχει τα μαθήματα της προπαρασκευής.
Μπορείτε να εκτελέσετε απλά "mnv tutor" και μετά να ακολουθήσετε τις
...
Σε σύστημα Unix μπορείτε επίσης να χρησιμοποιήσετε το πρόγραμμα "mnvtutor".
...
[Το αρχείο αυτό τροποποιήθηκε για τον MNV από τον Bram Moolenaar]
